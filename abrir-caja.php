            ...
            <div class="container-fluid pt-4 px-4">
                <div class="bg-secondary text-center rounded p-4">
                    <div class="d-flex align-items-center justify-content-between mb-4">
                        <h6 class="mb-0">Abrir Caja </h6>
                        <a href="cierres-de-caja.php">Cierres de caja</a>
                    </div>
                    <form action="abrir_caja.php" method="post">
  <div class="form-group">
    <label for="exampleInputEmail1">Valor Apertura Caja:</label>
    <input type="text" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Ingrese el valor de entrada caja" name="AperturaCaja">
