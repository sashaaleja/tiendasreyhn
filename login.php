...
<head>
    <meta charset="utf-8">
    <title>Mega Rey - App Login</title>
                ...
                <div class="col-12 col-sm-8 col-md-6 col-lg-5 col-xl-4">
                    <div class="bg-secondary rounded p-4 p-sm-5 my-4 mx-3">
                        ...
                        <div class="form-floating mb-3">
                            <input type="text" class="form-control" id="floatingInput" placeholder="name@example.com" name="EmailUsername">
                        ...
                        <p class="text-center mb-0">¿No tienes cuenta? <a href="register.php">Registrarse</a></p>
                    </div>
                </div>
            </div>
        </div>
