...
if($resultadoproductos = $Mysqli->query("SELECT * FROM stock")){
    while($row = $resultadoproductos->fetch_assoc()){
        ...
        $Productos .= "<option value='$Codigo_Producto'>$Codigo_Producto</option>";
    }
}
            ...
            <div class="container-fluid pt-4 px-4">
                <div class="bg-secondary text-center rounded p-4">
                    <div class="d-flex align-items-center justify-content-between mb-4">
                        <h6 class="mb-0">Imprimir etiquetas</h6>
                      
                    </div>
                    <form action="imprimir.php" method="post">
  <div class="form-group">
    <label for="Codigo">Codigo Producto:</label>
<select name="CodigoProducto" id="Codigo" class="form-control" style="background:black; color:white;">
    <option value="Seleccionar">Seleccionar Uno</option>
    <?php echo $Productos;?>
</select>
  </div>
  <div class="form-group">
    <label for="Cantidad">Cantidad:</label>
    <input type="text" class="form-control" id="Cantidad" name="CantidadE">
  </div>
 <br>
